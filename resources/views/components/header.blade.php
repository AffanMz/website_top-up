<header class="bg-transparent top-0 left-0 w-full">
    ...
    <nav class="container mx-auto p-4 flex items-center justify-between z-10 text-white">
        ...
        <div class="flex items-center gap-2 ">
            <ul>
                <li class="">
                    <a href="{{ route('landingPage') }}" class="flex items-center gap-2 mx-5 py-2 hover:underline">
            ...
            <ul>
                <li class="">
                    <a href="{{ $whatsappUrl }}bisa bantu saya?" target="_blank" class="flex items-center gap-2 mx-5 py-2 hover:underline">
            ...
            <ul>
                <li class="">
                    <a href="{{ route('membership') }}" class="flex items-center gap-2 mx-5 py-2 hover:underline">
                    <span>
        ...
        <div class="flex items-center gap-2 hover:underline">
            ...
            <a href="{{ route('login') }}" style="hover:underline">Masuk/Daftar</a>
        </div>
        @endauth
    </nav>
</header>